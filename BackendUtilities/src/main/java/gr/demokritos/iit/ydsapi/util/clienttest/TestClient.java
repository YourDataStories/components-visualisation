...
//        System.out.println(res);
    ...
    private static void testPost() throws Exception {
        httpPostGetPut qqomg = new httpPostGetPut();
        String url = "http://localhost:8084/YDSAPI/yds/embed/save";
        Map<String, String> params = new HashMap();
        params.put("project_id", "12345678");
        params.put("viz_type", "grid");
        final YDSFacet ydsf1 = new YDSFacet();
        ydsf1.setFacet_type("facet_type_3");
        ydsf1.setFacet_values(new ArrayList() {
            {
                add("f4");
                add("f5");
                add("f6");
        ...
        params.put("facets", new Gson().toJson(new ArrayList<YDSFacet>() {
            {
                add(ydsf1);
            }
        }, List.class));
