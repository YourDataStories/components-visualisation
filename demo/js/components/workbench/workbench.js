angular.module("yds").directive("ydsWorkbench", ["$ocLazyLoad", "$timeout", "$window", "Data", "Basket", "Workbench",
    function ($ocLazyLoad, $timeout, $window, Data, Basket, Workbench) {
        return {
            ...
            templateUrl: Data.templatePath + "templates/workbench/workbench.html",
            link: function (scope, element) {
                ...
                /**
                 * Show or hide alert messages in workbench
                 */
                ...
                /**********************************************/
                /**
                 * Add or remove comboboxes to/from the line chart configuration
                 */
                scope.addLineAxisY = Workbench.addLineAxisY;
                scope.removeLineAxisY = Workbench.removeLineAxisY;

                /**
                 * Create the line chart visualization based on the supplied configuration
                 */
                ...
                /**********************************************/
                /**
                 * Add or remove comboboxes to/from the scatter chart configuration
                 */
                scope.addScatterAxisY = Workbench.addScatterAxisY;
                scope.removeScatterAxisY = Workbench.removeScatterAxisY;

                /**
                 * Create the scatter chart visualization based on the supplied configuration
                 */
                ...
                /**********************************************/
                /**
                 * Add or remove comboboxes to/from the bar chart configuration
                 */
                scope.addBarAxisY = Workbench.addBarAxisY;
                scope.removeBarAxisY = Workbench.removeBarAxisY;

                /**
                 * Create the bar chart visualization based on the supplied configuration
                 */
                ...
                /**
                 * Get an axis object with all the attributes of the axis, and return only the ones needed
                 * by the API
                 * @param axis
                ...
                var gatherAxisAttrs = function (chart) {
                    ...
                    _.forEach(chart.axisYConfig, function (axis) {
                        if (!_.isNull(axis.selected) && !_.isUndefined(axis.selected) && _.isObject(axis.selected))
                ...
                var makeVisualizationRequests = function (axisAttrs, callback) {
                    if (axisAttrs.y.length > 0) {
                        ...
                        Workbench.getWorkbenchVisualisation(scope.workbench.selectedVis, scope.workbench.selectedView,
                            ...
                            .then(function (response) {
                                ...
                                Workbench.getWorkbenchVisualisation(scope.workbench.selectedVis, scope.workbench.selectedView,
                                    ...
                                    .then(function (response) {
                                        ...
                                        console.log("error in getWorkbenchVisualisation function");
                                    });
                            }, function (error) {
                                console.log("error in sparql call getWorkbenchVisualisation function");
                            });
                    } else
                ...
                /**
                 * Prepare the templates used in search results
                 */
